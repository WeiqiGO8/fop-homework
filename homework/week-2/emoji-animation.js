...
function emoji(x, y, eyesAreClosed) {
  push();
  translate(180, 80);
  ...
  if (eyesAreClosed) {
    ...
    //eyes and pupils
    fill(colorWhite);
    ellipse(x + 70, y - 50, w - 110, h - 195);
    ellipse(x - 50, y - 50, w - 110, h - 195);

    fill(colorBlack);
    ellipse(x + 70, y - 50, w - 180, h - 195);
    ellipse(x - 50, y - 50, w - 180, h - 195);
  }
  pop();
}
